...
## 2024-05-17 - Weak Password Reset Token Expiry
**Vulnerability:** Weak Password Reset Token Expiry set to 15 minutes.
**Learning:** Password reset tokens should have a short expiration time to minimize the window for interception or replay attacks.
**Prevention:** Set token expiration times to 5 minutes or less.
