...
const Shipping = () => {
  ...
  // 💡 What: Memoize country and state data generation
  // 🎯 Why: Calculating derived state directly in the render body causes expensive O(N) operations on every local state change (like form input keystrokes)
  // 📊 Impact: Prevents unnecessary recalculation of countries and states array on every re-render, optimizing performance
