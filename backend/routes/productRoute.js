...
// Security Fix: Prevent Arbitrary File Upload
// Changed upload.any() to upload.array('images') to strictly allow only the 'images' field array, reducing the attack surface.
