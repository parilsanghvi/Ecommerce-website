...
router.route("/register").post(rateLimiter(60 * 60 * 1000, 5, "Too many accounts created from this IP, please try again after an hour"), upload.any(), validate(registerSchema), registerUser);
